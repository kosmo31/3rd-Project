...
public class SearchController {
	...
	// 메인 검색폼에서 검색시 그외 검색은 searchrestcontroller내에 getServiceListSearch 메소드를 이용하여
	// ajax처리
	...
	public String mainBoard(Model model, HttpServletRequest req,
			@RequestParam(required = false, defaultValue = "1") Integer nowPage,
	...
	public ResponseEntity<Map<String, Object>> modifyActionBoard(@PathVariable Integer board_srl,
			HttpServletRequest req, HttpSession session, @RequestBody BoardVO vo, Model model) {
